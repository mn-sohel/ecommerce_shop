...
const FooterTop = () => {
  return (
    <Container>
        <div className='bg-[linear-gradient(90deg,rgba(244,244,244,1)29%,rgba(217,217,217,1)43%)] px-25 py-[114px] rounded-[25px]'>
            ...
            <p className='font-["Montserrat"] font-normal text-xl max-w-[475px] leading-[30px] mt-4 mb-8'>Browse our wide selection of electronics and find the perfect promo for you from newsletter.</p>
             <input 
            className='w-[494px] bg-white border border-[#CCC] py-[18px] px-6 rounded-[10px] mb-4' 
            type="text" 
