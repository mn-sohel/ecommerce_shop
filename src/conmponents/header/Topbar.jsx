    ...
    <div className='border-b border-[#BFBFBF] border-solid py-[22px]'>
        <Container>
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-12 font-["Montserrat"] font-normal text-sm relative after:content-[""] after:absolute after:w-[1px] after:h-[32px] after:bg-[#BFBFBF] after:left-[61%] after:top-[50%] after:-translate-y-1/2 '>
