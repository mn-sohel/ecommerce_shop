          ...
          <div>
            <ul className='flex items-center gap-20 font-["Montserrat"] font-bold text-base leading-6 text-white'>
              <li className='relative' ref={categoryDropdownRef} >
                <button onClick={handleCategoryDropdown} className='flex items-center gap-4 cursor-pointer'><FaBars /> All Categories</button>
              ...
              <li className='relative' ref={productDropdownRef}>
                <button onClick={handleProductDropdown} className='flex items-center gap-4 cursor-pointer'>Products <FaAngleDown /></button>
